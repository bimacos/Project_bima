        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="nav-item"><a href="{{route('admin.home')}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              </li>
              @endif
               @if( Auth::user()->id_level == '2')
              <li class="nav-item"><a href="{{route('waiter.home')}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              </li>
              @endif
               @if( Auth::user()->id_level == '3')
              <li class="nav-item"><a href="{{route('kasir.home')}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              </li>
              @endif
                @if( Auth::user()->id_level == '4')
              <li class="nav-item"><a href="{{route('owner.home')}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              </li>
              @endif
